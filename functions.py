...
from config import (OPENAI_API_KEY, AIRTABLE_API_KEY, AIRTABLE_BASE_ID,
                    AIRTABLE_TABLE_NAME, AUDIO_STORAGE_PATH, TTS_VOICE,
                    BACKGROUND_MUSIC_PATH, BACKGROUND_VOLUME_REDUCTION,
                    REPLIT_BASE_URL)
...
def register_user():
    ...
    return jsonify({
        "message":
        "Congratulations! You are now ready for the 7 day visualization challenge",
        "record_id": record['id']
    }), 200
